...
```{r}
Data <- read.csv('D:\\IISc Banglore\\M Tech Project\\MTech_Project_Python\\Clinical and Immuno_Data.csv') # to let user choose file - "file.choose(), header = T, row.names = 1" within read.csv()
```
